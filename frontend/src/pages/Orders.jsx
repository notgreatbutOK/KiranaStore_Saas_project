    ...
    <Layout>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded shadow-lg p-8 w-96 print:shadow-none" id="receipt">
            ...
            <div className="flex gap-3 mt-6 print:hidden">
              <button onClick={printReceipt} className="flex-1 bg-blue-600 text-white py-2 rounded hover:bg-blue-700">🖨️ Print</button>
              <button onClick={() => setReceipt(null)} className="flex-1 bg-gray-400 text-white py-2 rounded hover:bg-gray-500">Close</button>
            </div>
          </div>
        </div>
      )}
      ...
      <div className="bg-white shadow rounded p-6 max-w-md mb-8">
        ...
        <div className="mb-4">
          ...
          <select className="w-full border p-2 rounded" onChange={(e) => setSelectedCustomer(e.target.value)}>
        ...
        <div className="mb-4">
          ...
          <input className="w-full border p-2 rounded" type="number" value={quantity} onChange={(e) => setQuantity(e.target.value)} />
        </div>
        <div className="mb-6">
          <label className="block text-gray-600 mb-1">Payment Type</label>
          <select className="w-full border p-2 rounded" onChange={(e) => setPaymentType(e.target.value)}>
            <option value="cash">Cash</option>
            <option value="udhaar">Udhaar</option>
          </select>
        </div>
        <button onClick={createOrder} className="bg-blue-600 text-white px-6 py-2 rounded w-full hover:bg-blue-700">
          Create Order
        </button>
      </div>
